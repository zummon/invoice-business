...
{#each Object.keys(data) as lng, i (`lang-${i}`)}
		<button class="block font-bold duration-300 p-2 {q.lang === lng ? "bg-blue-500 text-gray-100" : "text-gray-900 bg-gray-100 hover:bg-blue-500 focus:bg-blue-500 hover:text-gray-100 focus:text-gray-100"}" on:click={() => {
			q.lang = lng
			}}>
			{lng =='th' ? 'ไทย' : 'Eng'}
		</button>
	...
	{#each Object.keys(data[q.lang].label) as dc, i (`doc-${i}`)}
		<button class="block font-bold duration-300 p-2 {q.doc === dc ? "bg-blue-500 text-gray-100" : "text-gray-900 bg-gray-100 hover:bg-blue-500 focus:bg-blue-500 hover:text-gray-100 focus:text-gray-100"}" on:click={() => {
			q.doc = dc
			}}>
...
<div class="font-sans bg-white text-black p-4 max-w-[60rem] mx-auto print:max-w-none print:mx-0">
	<div class="grid grid-cols-2 gap-4 mb-3">
		<div class="my-auto">
			<div class="" on:click={() => {}}>
				<img class="mb-3" src={q.vendorLogo} alt="" width="" height="">
			</div>
			<h3 class="text-xl mb-1" contenteditable="true" bind:textContent={q.vendorName}></h3>
			<p class="ml-3 mb-1" contenteditable="true" bind:textContent={q.vendorId}></p>
			<p class="ml-3 mb-6" contenteditable="true" bind:textContent={q.vendorAddress}></p>
			<h4 class="mb-1">{l.client}</h4>
			<h3 class="text-xl mb-1" contenteditable="true" bind:textContent={q.clientName}></h3>
			<p class="ml-3 mb-1" contenteditable="true" bind:textContent={q.clientId}></p>
			<p class="ml-3 mb-3" contenteditable="true" bind:textContent={q.clientAddress}></p>
			<h4 class="">
				<span class="font-bold">{l.subject}</span>
				<span class=""> </span>
				<span class="text-lg text-blue-500" contenteditable="true" bind:textContent={q.subject}></span>
			</h4>
		</div>
		<div class="my-auto">
			<h1 class="text-4xl text-blue-500 mb-3">{l.title}</h1>
			<p class="ml-3 mb-1" contenteditable="true" bind:textContent={q.ref}></p>
			<p class="ml-3 mb-3" contenteditable="true" bind:textContent={q.date}></p>
			<div class="bg-gray-50 px-3 py-6 mb-3">
				{#if q.doc !== 'receipt'}
					<h4 class="mb-1">{l.duedate}</h4>
					<p class="px-2 py-0.5 border bg-white mb-1" contenteditable="true" bind:textContent={q.duedate}></p>
				{/if}
				<h4 class="mb-1">{l.paymethod}</h4>
				<p class="px-2 py-0.5 border bg-white" contenteditable="true" bind:textContent={q.paymethod}></p>
			</div>
			<h4 class="text-right">
	...
	<table class="w-full">
			...
			<tr class="">
				...
				<th class="">
					<div class="flex">
						...
						<button class="p-2 focus:bg-blue-700 hover:bg-blue-700 transition duration-300 ease-in-out print:hidden" on:click={addItem}>
						...
						<button class="p-2 focus:bg-blue-700 hover:bg-blue-700 transition duration-300 ease-in-out print:hidden" on:click={removeItem}>
		...
		<tfoot class="">
			<tr class="">
				<td class="pr-3" colspan="2" rowspan={q.doc === 'receipt' ? 4 : 3}>
					<div class="bg-gray-50 p-3 mb-3">
						...
						<p class="px-2 py-0.5 border bg-white" contenteditable="true"><br><br></p>
						<p class="px-2 py-0.5 mb-3 border-b border-r border-l bg-white" contenteditable="true"></p>
					</div>
				</td>
			...
			<tr class="">
				...
				<td class="py-1 px-2 border-b text-right whitespace-nowrap" contenteditable="true" 
	...
	<div class="grid grid-cols-2 gap-4">
		<div class="">
			...
			<p class="ml-3 mb-3" contenteditable="true" bind:textContent={q.note}></p>
		...
		<div class="">
			...
			<p class="px-2 py-0.5 mb-3 border-b border-r border-l" contenteditable="true"></p>
		</div>
	</div>
</div>

<div class="flex flex-wrap justify-center items-center my-4 print:hidden">
	<button class="block font-bold duration-300 p-2 text-gray-100 bg-blue-500 hover:bg-gray-100 focus:bg-gray-100 hover:text-gray-900 focus:text-gray-900" on:click={() => window.print()}>
		Print
	</button>
</div>